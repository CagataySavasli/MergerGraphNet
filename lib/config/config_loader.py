"""
This file is responsible for loading configuration data from a YAML file.
The `ConfigLoader` class provides a clean interface for reading, parsing,
and accessing the configuration, with robust error handling.
"""
